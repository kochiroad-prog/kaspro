...
export default async function DashboardPage() {
  const [stats, txResult, kasResult] = await Promise.all([
    getDashboardStats(),
  ...
  const s = stats ?? {
    ...
    keuntungan_hari_ini: 0, pemasukan_bulan_ini: 0, pengeluaran_bulan_ini: 0, keuntungan_bulan_ini: 0
  }
    ...
    <div className="space-y-5 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Ringkasan keuangan usaha Anda</p>
        </div>
        <AddTxButton />
      </div>
